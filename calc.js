...
function calculatePrice() {
  if (document.getElementById("paperType").value === "glossy") {
    document.getElementById("price").value = formatter.format(
      glossy[document.getElementById("posterHeight").value].base +
        glossy[document.getElementById("posterHeight").value].multiplier *
          document.getElementById("posterLength").value,
    );
  }
  if (document.getElementById("paperType").value === "satin") {
    document.getElementById("price").value = formatter.format(
      satin[document.getElementById("posterHeight").value].base +
        satin[document.getElementById("posterHeight").value].multiplier *
          document.getElementById("posterLength").value,
    );
  }
  if (document.getElementById("paperType").value === "fabric") {
    document.getElementById("price").value = formatter.format(
      fabric[document.getElementById("posterHeight").value].base +
        fabric[document.getElementById("posterHeight").value].multiplier *
          document.getElementById("posterLength").value,
    );
  }
}
